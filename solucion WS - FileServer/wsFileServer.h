...
int wsFilens__readFromFile(wsFilens__tFileName fileName, int offset, int size, wsFilens__tData *data);
int wsFilens__writeToFile(wsFilens__tFileName fileName, int offset, wsFilens__tData data, int *result);
